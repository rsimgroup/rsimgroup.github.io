...
if ($FormFields{"submit"} eq "Accept the License") {
  print "<META HTTP-EQUIV=refresh CONTENT=\"0; url=http://rsim.cs.uiuc.edu/alp/alpbench2/download.html\">\n";
  print "</head>\n";

  if(open(UsersLog,">>"."/usr/dcs/www/www-root/rsim/cgi-bin/alpbenchusers")) {
