...
if ($FormFields{"submit"} eq "Accept") {
  print "<META HTTP-EQUIV=refresh CONTENT=\"1; url=http://rsim.cs.uiuc.edu/alp/alpbench/download.html\">\n";
  print "</head>\n";


  if(open(UsersLog,">>/home/rsimgroup/public_html/cgi-bin/users")) {
