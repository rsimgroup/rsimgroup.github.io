...
run face_project -imDir data/csuScrapShots/normSep2002sfi train/scraps/feretPCA.train imagelists/scrap_all_x4.srt distances/scraps/PCA_MahCosine MahCosine
...
run face_project -imDir data/csuScrapShots/normSep2002sfi -lastphase -infile 00001aa.sfi -outfile distances.dat train/scraps/feretPCA.train imagelists/scrap_all_x4.srt distances/scraps/PCA_MahCosine MahCosine