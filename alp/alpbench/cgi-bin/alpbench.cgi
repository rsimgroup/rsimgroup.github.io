...
open(FormLog,">>"."/home/rsimgroup/public_html/alp/alpbench/cgi-bin/log");
...
if ($FormFields{"submit"} eq "Accept the License") {
  print "<META HTTP-EQUIV=refresh CONTENT=\"0; url=http://rsim.cs.uiuc.edu/rsim/Distribution/rsim-1.0.tar.gz\">\n";
  print "</head>\n";

  if (open(UsersLog,">>"."/home/rsimgroup/public_html/alp/alpbench/cgi-bin/users")) {
...
# others to mail: srampell@cs.rice.edu, Partha.Ranganathan@hp.com
  ...
  print "Click <a href=\"http://rsim.cs.uiuc.edu/rsim\">here</a> to return\n";
  print "to the main RSIM page.\n";
  print "</body>\n";
}
